...
function Sidebar() {
  return (
    <div>
      ...
      <p className="px-2 py-1 my-3 rounded-full">
        Software Engineer
      </p>
      <a
        className="px-2 py-1 my-3 rounded-full flex items-center justify-center"
        href=""
        download="name"
      >
      ...
      <button className="bg-gradient-to-r from-slate-500 to-blue-400 border border-black w-8/12 rounded-full py-2 px-5 text-white my-2"
