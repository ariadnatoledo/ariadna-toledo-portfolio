...
function Sidebar() {
  return (
    <div>
      ...
      <button className="bg-gradient-to-r from-slate-500 to-blue-400 w-8/12 rounded-full py-2 px-5 text-white my-2">Email Me</button>
      <button className="bg-gradient-to-r from-slate-500 to-blue-400 w-8/12 rounded-full py-2 px-5 text-white my-2">Toggle Theme</button>
    </div>
  );
}
